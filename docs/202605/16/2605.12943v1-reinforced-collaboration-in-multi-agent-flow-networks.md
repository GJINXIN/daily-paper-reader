...
tldr: 针对多智能体系统（MAS）中因工作流设计不当或输出错误导致的误差传播问题，本文提出MANGO框架。该框架通过构建基于历史成功案例的流网络，结合强化学习与文本梯度联合优化工作流路径与智能体行为。此外，引入跳过机制提升效率。实验证明，MANGO在多个基准测试中显著提升了性能与效率，并具备良好的泛化能力。
selection_source: fresh_fetch
motivation: 解决多智能体协作中因工作流设计不佳或智能体输出不准导致的误差传播及性能下降问题。
method: 提出MANGO框架，利用流网络组织协作，并结合强化学习与文本梯度优化路径与行为，同时采用跳过机制减少冗余更新。
result: "在七个基准测试中，MANGO比现有最优基准性能提升高达12.8%，效率提高47.4%，且在未知领域表现出强泛化性。"
conclusion: MANGO通过数据驱动的流网络优化，有效提升了多智能体系统的协作效率与任务处理能力。
---

## 摘要
多智能体系统通过将复杂任务分解为由不同智能体处理的专门子任务，为扩展大语言模型（LLMs）提供了一种强大的方式。然而，它们的性能往往受到错误传播的阻碍，这些错误源于次优的工作流设计或不准确的智能体输出，并可能在智能体协作过程中传播，从而降低最终结果的质量。为了应对这些挑战，我们提出了 MANGO（多智能体网络梯度优化），这是一个数据驱动的框架，通过从过去成功的工作流中构建的流网络来组织和优化智能体协作。MANGO 结合了强化学习和文本梯度，以联合优化工作流路径和智能体行为，同时通过跳过机制防止对已充分优化的智能体进行冗余更新，从而提高效率。在七个基准测试上的广泛实验表明，MANGO 相比最先进的基准模型实现了高达 12.8% 的性能提升，效率提高了 47.4%，并能有效泛化到未见领域。我们的代码和数据集已在 https://github.com/openJiuwen-ai/agent-store/tree/main/community/mango 公开。
