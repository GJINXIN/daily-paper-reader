...
score: 7.0
evidence: 多智能体系统中的防御
tldr: "针对多智能体系统（MAS）中易受“传染性越狱”攻击的问题，本文提出了一种无需训练的预见性引导局部净化框架（FLP）。该框架通过模拟未来多轮对话轨迹，利用多角色模拟策略检测智能体响应的一致性，从而识别并清除受感染的对抗性样本。实验证明，FLP能将感染率从95%以上降至5.47%以下，同时有效保留了智能体间的交互多样性。"
selection_source: fresh_fetch
motivation: 现有的全局防御方法往往导致智能体响应同质化，且无法有效应对源于局部交互行为的传染性越狱攻击。
method: 提出FLP框架，通过多角色模拟预测未来行为轨迹，并利用响应多样性作为诊断信号，结合递归二分诊断（RBD）定位并清除受感染的图像。
result: "实验结果显示，FLP将最大累积感染率显著降低至5.47%以下，且各项指标均接近良性基准，证明了其在防御攻击的同时能维持正常的交互功能。"
conclusion: 本研究通过局部预见性推理和多样性诊断，为多智能体系统提供了一种高效、无需训练且能保持系统多样性的防御新范式。
---
