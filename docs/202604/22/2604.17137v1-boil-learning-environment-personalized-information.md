...
## 摘要
在复杂环境中导航对多智能体系统提出了挑战，需要从有限的信息中高效提取见解。在本文中，我们介绍了黑盒预言机信息学习（Blackbox Oracle Information Learning，BOIL）过程，这是一种从环境结构中提取有价值见解的可扩展解决方案。利用 Pagerank 算法和公共信息最大化，BOIL 促进了信息的提取，以指导适用于覆盖、巡逻和随机可达性等问题的长期智能体行为。通过实验，我们证明了 BOIL 在生成有助于在长周期内提高性能的策略分布方面的有效性，在复杂环境中超越了启发式方法。
