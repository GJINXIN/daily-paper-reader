...
tags: ["query:mas-ss"]
score: 6.0
evidence: LLM智能体代拟消息与对话评估
tldr: 针对LLM代理在代写消息时可能泄露隐私的问题，本文将隐私保护通信重新定义为“信息充分性”任务。除了传统的抑制和泛化策略，研究者提出了“自由文本匿名化”策略，即用功能等效的替代信息替换敏感属性。通过引入多轮对话评估协议，研究发现该策略在隐私与效用之间取得了最佳平衡，并揭示了单条消息评估会严重低估隐私泄露风险。
selection_source: fresh_fetch
motivation: 现有的LLM隐私保护方法局限于单条消息的抑制和泛化，无法应对多轮对话中的隐私泄露风险及用户对隐私定义的差异。
method: 将隐私保护建模为信息充分性任务，提出自由文本匿名化策略，并建立包含792个场景的多轮对话评估协议。
result: "自由文本匿名化在隐私保护和信息效用之间表现最优，而传统的泛化策略在多轮追问下隐私保护率会下降多达16.3%。"
conclusion: 隐私保护应从单次处理转向动态对话语境，且匿名化是比抑制和泛化更有效的LLM隐私保护手段。
---
