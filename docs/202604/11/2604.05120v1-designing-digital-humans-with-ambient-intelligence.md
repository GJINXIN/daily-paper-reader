...
motivation: 现有的数字人大多孤立运行，缺乏对用户所处物理环境和上下文背景的感知能力。
method: 提出将环境智能（AmI）技术与数字人集成，通过传感器和IoT数据构建具备情境感知能力的设计框架与架构。
result: 定义了AmI在数字人行为中的关键角色，展示了在金融和零售场景下的应用模式，并制定了隐私与数据治理指南。
conclusion: 环境智能数字人作为一种新型AI交互代理，能够超越简单的对话，根据用户所处的情境提供主动且个性化的支持。
---
