...
tldr: 本文探讨了复杂自治AI系统中的问责制问题，重点关注多智能体系统（MAS）中智能体之间的问责机制而非组织流程。通过跨学科调研，文章明确了问责制的定义，提出了现实应用案例，并识别了构建可问责智能体的研究挑战与初步方案，为开放式社会技术系统中的自主元素参与问责过程奠定了理论基础和研究路线图。
selection_source: fresh_fetch
motivation: 现有的AI问责研究多集中于人类组织层面，缺乏对多智能体系统中智能体之间如何相互问责的深入探讨。
method: 通过深入调研多学科文献来界定问责制概念，并结合现实应用场景识别多智能体系统中的研究挑战。
result: 明确了智能体问责制的定义，并针对构建可问责智能体提出了一系列研究挑战及其初步解决方案。
conclusion: 本文为在开放式社会技术系统中实现自主智能体的问责过程提供了理论框架和未来研究路线图。
---

## 摘要
人工智能系统正变得日益复杂、普及且自主，引发了人们对其对个人和社会影响的日益关注。为此，研究人员开始探讨如何确保 AI 决策背后的方法是透明的，其决策对人类是可解释的，并符合人类价值观和伦理原则。作为这一研究趋势的一部分，AI 系统内部对问责制的需求已受到关注，但这一概念被证明难以定义；本文旨在解决这一问题。与近期的大多数工作不同，我们不讨论 AI 开发和部署过程中人类组织流程内的问责制；相反，我们探讨在多智能体系统（MAS）中，智能体（可能包括人类智能体）对其他智能体负责，或让其他智能体对其负责意味着什么。在这项工作中，我们做出了以下贡献：对多个学科中关于问责制的现有工作进行了深入调研，力求为该概念确定一个连贯的定义；提供了一个多智能体系统应用领域的现实案例，展示了使智能体遵循问责流程的益处；并为 MAS 社区在构建可问责智能体方面确定了一系列研究挑战，勾勒出了一些初步解决方案，从而为未来的研究规划了路线图。我们的重点是奠定基础，使开放式社会技术系统中的自主单元能够参与问责流程。
