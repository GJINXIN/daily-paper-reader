...
tags: ["query:mas-ss"]
score: 7.0
evidence: 模拟环境中的多智能体协作
tldr: 针对多智能体具身系统在空间协调和时间推理方面的挑战，本文提出CoEnv框架。该框架引入“组合环境”概念，通过将现实世界与仿真环境协同集成，使多机器人代理能在统一决策空间内感知意图并协作。CoEnv包含场景重建、VLM驱动的动作合成及带碰撞检测的虚实迁移三个阶段，显著提升了多臂协作任务的成功率和执行效率，为多智能体具身智能提供了新范式。
...
result: 在多臂操作基准测试中的实验证明，CoEnv能显著提高任务成功率和执行效率，并确保了实际部署的安全性。
