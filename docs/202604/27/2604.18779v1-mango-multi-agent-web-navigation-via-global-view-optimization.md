...
tldr: Mango 针对现有 Web 智能体在复杂网站中导航效率低、缺乏全局视野的问题，提出了一种基于全局视图优化的多智能体导航方法。该方法将起始 URL 选择建模为多臂老虎机问题，利用 Thompson 采样动态分配导航预算，并结合情节记忆学习历史经验。实验证明 Mango 在 WebVoyager 和 WebWalkerQA 任务上显著优于现有基准，展现了强大的导航效率和通用性。
selection_source: fresh_fetch
motivation: 传统 Web 智能体通常从根 URL 开始探索，在面对深层级结构的复杂网站时容易陷入导航陷阱或效率低下。
method: 将 URL 选择建模为多臂老虎机问题，采用 Thompson 采样动态确定最优起始点，并引入情节记忆组件以学习历史导航经验。
result: "在 WebVoyager 和 WebWalkerQA 任务上，Mango 的成功率分别达到 63.6% 和 52.5%，显著超越了现有最强基准模型。"
conclusion: Mango 通过全局视图优化和动态预算分配，有效提升了 Web 智能体在复杂层级结构网站中的导航性能和泛化能力。
---
