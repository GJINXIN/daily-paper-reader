...
motivation: 现有大语言模型多智能体系统主要依赖临时性提示词，缺乏一种基于策略的系统化方法来控制和引导智能体的对话行为。
