...
tldr: 本文系统地梳理了代理式人工智能（Agentic AI）的攻击面，涵盖了工具使用、RAG和自主决策带来的安全风险。研究者通过对2023-2025年文献的综述，构建了包含提示词注入、知识库污染及多智能体威胁的攻击分类法，并提出了评估指标和防御清单。该研究为理解和缓解自主AI系统的安全威胁提供了重要框架，填补了现有防御措施的空白。
selection_source: fresh_fetch
motivation: 随着大模型与工具及自主循环的结合，代理式AI在扩展能力的同时也极大地增加了系统的攻击表面和安全风险。
method: 通过对2023至2025年间的20多项研究进行系统化综述，构建了涵盖攻击分类、威胁模型、评估指标及防御机制的全面框架。
result: 发现了间接提示词注入、代码执行漏洞和跨智能体操纵等新型攻击向量，并评估了现有防御手段在应对这些威胁时的局限性。
conclusion: 提出了针对代理式AI的阶段性安全检查清单，并指出了在稳健API、可验证行为和供应链保护等领域的未来研究方向。
---

## 摘要
近期的 AI 系统将大语言模型与工具、通过检索增强生成 (RAG) 获取的外部知识，甚至自主多智能体决策循环相结合。这种代理式 AI (Agentic AI) 范式在极大扩展能力的同时，也显著扩大了攻击面。在本文的系统化研究中，我们勾勒出了基于大语言模型 (LLM) 的代理系统的信任边界和安全风险。我们开发了一个全面的攻击分类法，涵盖了提示词级注入、知识库投毒、工具/插件漏洞利用以及多智能体涌现威胁。通过详细的文献综述，我们综合了 2023 年至 2025 年间的证据，包括 20 多项同行评审和存档研究、行业报告及标准。研究发现，代理系统引入了间接提示词注入、代码执行漏洞利用、RAG 索引投毒和跨智能体操纵等新向量，这些威胁已超出传统的 AI 安全范畴。我们定义了攻击者模型和威胁场景，并提出了评估安全态势的指标（如不安全操作率、权限提升距离）。本综述考察了输入清理、检索过滤器、沙箱、访问控制和“AI 护栏”等防御措施，评估了其有效性并指出了保护尚存缺失的领域。为协助从业者，我们概述了防御控制措施，并为部署代理式 AI 提供了分阶段的安全检查清单（涵盖设计时加固、运行时监控和事件响应）。最后，我们总结了安全自主 AI 领域开放的研究挑战（如鲁棒的工具 API、可验证的智能体行为、供应链保障），并讨论了伦理和负责任的披露实践。我们系统化了近期研究发现，旨在帮助研究人员和工程师理解并缓解代理式 AI 中的安全风险。
