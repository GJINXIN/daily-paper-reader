...
title_zh: 具有臂访问限制的有向网络中的协作老虎机学习
...
## 摘要
不确定性下的顺序决策通常涉及多个智能体，通过与随机环境的重复交互来学习哪些动作（臂）能产生最高奖励。这种设定通常被建模为协作式多智能体多臂老虎机问题，其中智能体在没有中心化协调的情况下进行探索并共享信息。在许多现实系统中，智能体具有异构能力，这限制了它们对臂子集的访问，并且它们在由有向图表示的非对称网络上进行通信。在这项工作中，我们研究了具有部分臂访问权限的多智能体多臂老虎机问题，其中智能体仅探索和利用其可用的臂，同时与邻居交换信息。我们提出了一种基于分布式共识的置信上限（UCB）算法，该算法同时考虑了臂的可访问性结构和网络非对称性。我们的方法采用了一种质量守恒的信息混合机制，确保尽管存在访问限制和非对称信息流，整个网络中的奖励估计仍保持无偏。在标准随机假设下，我们为每个智能体建立了对数累积遗憾，并明确了其对网络混合特性和臂访问限制的依赖关系。这些结果量化了异构臂访问和有向通信如何影响协作学习性能。
